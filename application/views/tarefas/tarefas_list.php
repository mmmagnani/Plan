        ...
        <div class="card">
            <div class="card-body">
                <div class="card-content table-responsive">
                	<?php if(($bloqueio == 0) && ($this->session->userdata('anofiscal') >= date('Y')) && ($this->permission->check($this->session->userdata('permissao'), 'aTarefas'))) { ?>
                    ...
                    <?php } ?>
						...
						<?php if(($bloqueio == 0) && ($this->session->userdata('anofiscal') >= date('Y')) && ($this->permission->check($this->session->userdata('permissao'), 'aTarefas'))) { ?>
                        <?= anchor(site_url('tarefas/importar'),'<i class="fas fa-file-upload"></i> ' . $this->lang->line('import_plan'), 'class="btn btn-warning"'); ?>
						<?php } ?>
                        <?= anchor(site_url('tarefas/exportar'),'<i class="fa fa-file-download"></i> ' . $this->lang->line('export_to_plan'), 'class="btn btn-danger"'); ?>
                        <p><h5>Legenda: <b>Autorizado</b> | <b> * Autorizado com parte da reserva</b> | <span style="color:#0000FF"><b>Reserva</b></span></p></h5>
