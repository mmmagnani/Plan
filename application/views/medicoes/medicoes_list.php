		...
		<div class="card">
			<div class="card-body">
				<div class="card-content table-responsive">
					<?= anchor(site_url('medicoes/create/' . $id),'<i class="fa fa-plus"></i> '.$this->lang->line('app_create'), 'class="btn btn-success"'); ?>
                ...
                <hr />
                <a href="<?= site_url('registros') ?>" class="btn btn-dark">
...
<script type="text/javascript">  
	$(document).ready(function () {
		...
		var datatable = $('#table').DataTable({
			...
			"order": [],
			"ajax": {
				url: "<?= site_url('medicoes/datatable/'.$id); ?>",
				type: "POST"
			},
			"columnDefs": [
				{
