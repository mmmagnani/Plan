                    ...
                    <form action="<?= $action; ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <textarea class="form-control" name="formula" id="formula" style="resize:none" cols="50" rows="5" onkeyup="this.value = this.value.toUpperCase()"><?= $formula; ?>
                            </textarea>
                            <?= form_error('formula') ?>                              
                            </div>
                        </div>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                            	...
                            	<input type="text" class="form-control" name="unidade_meta" id="unidade_meta" value="<?= $meta; ?>" />
