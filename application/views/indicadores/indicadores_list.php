	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="card">
			<div class="card-body">
                ...
                <?php if ($this->permission->check($this->session->userdata('permissao'), 'cIndicadores')) { ?>
					<?= anchor(site_url('indicadores/create'),'<i class="fa fa-plus"></i> '.$this->lang->line('app_create'), 'class="btn btn-success"'); ?>
                <?php } ?>
...
<script type="text/javascript">  
	$(document).ready(function () {
		...
		var datatable = $('#table').DataTable({
			...
			"order": [],
			"ajax": {
				url: "<?= site_url('indicadores/datatable'); ?>",
				type: "POST"
			},
			"columnDefs": [
				{
