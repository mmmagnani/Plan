                   ...
                   <div class="row">
                     <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="titulo" id="titulo" style="resize:none" cols="50" rows="5" onkeyup="this.value = this.value.toUpperCase()"><?= $titulo; ?></textarea>
                            <?= form_error('titulo') ?>
                        </div>
                     </div>
                   </div>
					 ...
					 <div class="col-lg-3 col-md-3 col-sm-12">
                     	<div class="form-group">
                        	<label for="calendario">
                            	<?= ucfirst($this->lang->line('list_project_on_calendar')) ?>
                            </label>
                            <?php 
                            	$options = array(
									'' => '',
                                ...
                                echo form_dropdown('calendario', $options, $calendario, array('class' => 'form-control'));
                                echo form_error('calendario');
                           	?>
                        </div>
                     </div>
                     <div class="col-lg-3 col-md-3 col-sm-12">
                     	<div class="form-group">
                        	<label for="obras">
                            	<?= ucfirst($this->lang->line('list_tasks_on_calendar')) ?>
                            </label>
                            <?php 
                            	$options = array(
									'' => '',
