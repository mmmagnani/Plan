...
//                     $out["target"]= $this->analyse_expression( $out['target'], true);
		...
		elseif($pattern=="EEEE, dd' de 'MMMM' de 'YYYY" && $txt !=""){
			setlocale(LC_TIME,"portuguese","ptb","bra","BRA","BR","pt_BR.utf-8","pt-BR","pt_BR.UTF-8");
			return strftime("%A, %d de %B de %Y", strtotime($txt));
			}
        else
            return $txt;
